...
import sys
import numpy as np
#sys.path.append('/data/users1/afani1/babyBrains/wirehead')
...
# Mongo config
#DBNAME              = "babywire_ageExperiment"
#MONGOHOST           = "arctrdcn018.rs.gsu.edu"
#client              = MongoClient("mongodb://" + MONGOHOST + ":27017")
#db                  = client[DBNAME]
WIREHEAD_CONFIG     = "config.yaml"
PATH_TO_DATA        = "/data/users1/afani1/babyBrains/updatedbabydata/"
DATA_FILES          = ["labeling3_inf7.nii.gz",
                    "labeling3_inf10.nii.gz",
                    "16203_03_01_uglyBabyHead2.nii.gz",
                    "labeling3_inf9.nii.gz",
                    "labeling3_inf11.nii.gz",
                    "15824_03_02_uglyBabyHead2.nii.gz",
                    "16025_03_02_uglyBabyHead2.nii.gz",
                    "16339_03_02_uglyBabyHead2.nii.gz",
                    "16460_03_02_uglyBabyHead2.nii.gz",
                    "labeling3_inf12.nii.gz",
                    "10942_05_03_uglyBabyHead2.nii.gz",
                    "16203_03_03_uglyBabyHead2.nii.gz",
                    "16227_03_03_uglyBabyHead2.nii.gz",   
